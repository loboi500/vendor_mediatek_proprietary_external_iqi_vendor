...
#ifndef __IQI_UTILS_H__
#define __IQI_UTILS_H__
...
#define IQI_LOG(suffix, tag, ...) do { \
LOG_##suffix(tag, __VA_ARGS__); \
} while (0)

#define IQI_LOGE(tag, ...) IQI_LOG(E, tag, __VA_ARGS__)
#define IQI_LOGW(tag, ...) IQI_LOG(W, tag, __VA_ARGS__)
#define IQI_LOGI(tag, ...) IQI_LOG(I, tag, __VA_ARGS__)
#define IQI_LOGD(tag, ...) IQI_LOG(D, tag, __VA_ARGS__)
#define IQI_LOGV(tag, ...) IQI_LOG(V, tag, __VA_ARGS__)

#endif // __IQI_UTILS_H__